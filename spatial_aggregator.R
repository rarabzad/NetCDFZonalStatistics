#' @title spatial aggregator
#' @description
#' This function is designed for spatial aggregation of NetCDF files.
#' @param ncFile file path where NetCDF file is located
#' @param weightsFile (optional)  grid cells weights file path generated by \code{grids_weights_generator}. If missing, a uniform spatial aggregation is performed across the entire domain of the netcdf file.
...
#' spatial_aggregator(ncFile=ncFile)
#' @author Rezgar Arabzadeh, University of Waterloo, October 2023
spatial_aggregator<-function(ncFile,
                                  weightsFile=NULL,
                                  hrufile = NULL,
                                  varnames = NULL,
                                  dimnames = NULL,
